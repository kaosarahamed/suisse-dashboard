...
function ApproveUID({ showUID, setShowUID, id }) {
  ...
  return (
    <Modal className="modal fade" show={showUID} onHide={setShowUID}>
      <div role="document">
        <div>
...
ApproveUID.propTypes = {
  setShowUID: PropTypes.func,
  showUID: PropTypes.bool,
  id: PropTypes.string,
};
export default ApproveUID;
