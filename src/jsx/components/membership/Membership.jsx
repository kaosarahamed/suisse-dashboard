...
import MembershipLoading from "../../../loading/Membership-loading";
...
const Membership = () => {
  ...
  const { data, isLoading, isError } = useGetAllMembershipByAdminQuery({
    page,
    limit,
  ...
  const totalItems = data?.totalMemberships;
  ...
  if (!isLoading && !isError && data?.memberships?.length === 0) {
    content = (
  ...
  if (!isLoading && !isError && data?.memberships?.length > 0) {
    content = data?.memberships?.map((item, index) => {
      const {
        title,
        savePrice,
        existPrice,
  ...
  return (
    <div className="custom-position">
      <div className="d-flex align-items-center mb-4 flex-wrap ">
        <h4 className="fs-20 font-w600  me-auto">All Memberships</h4>
        <Tab.Container
      ...
      <div className="row ">
        ...
        <div className="d-md-flex d-block align-items-center justify-content-between text-center  flex-wrap mt-md-0 mt-3">
          <div className="mb-md-0 mb-2">
            <h5 className="mb-0">Showing {totalItems} Memberships</h5>
          </div>
          {totalItems > 0 && (
            <Pagination
          ...
          <EditMembership isShow={isShow} setIsShow={setIsShow} id={id} />
        </div>
      </div>
      <Toaster />
    </div>
