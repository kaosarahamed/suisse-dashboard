...
function EditCategory({ isShow, setIsShow, id }) {
  ...
  const { title, category, status, logo, image } = categoryData || {};
      ...
      <div className="modal-body">
        <form onSubmit={handleSubmit}>
          <div className="row">
            ...
            <div className="col-xl-6  col-md-6 mb-4">
              <label className="form-label font-w600">
                Select Category Logo<span className="text-danger ms-1">*</span>
              </label>
              <input
                type="file"
                name="logo"
            ...
            <div className="col-xl-6  col-md-6 mb-4">
              <label className="form-label font-w600">
                Select Category Image<span className="text-danger ms-1">*</span>
              </label>
              <input
                type="file"
                name="image"
