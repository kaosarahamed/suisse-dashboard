...
function EditReview({ editModal, setEditModal, id }) {
  const [status, setStatus] = useState("");
  const { data } = useGetOneReviewQuery(id);
  const [
    updateReviewStatus,
        ...
        <div>
          <form onSubmit={handleSubmit}>
            <div className="modal-header">
              <h4 className="modal-title fs-20">Update Review Status</h4>
              <button
                type="button"
                className="btn-close"
